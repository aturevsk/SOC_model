###########################################################################
## Makefile generated for component 'predict_soc'. 
## 
## Makefile     : predict_soc_rtw.mk
## Generated on : Fri Mar 27 17:29:41 2026
## Final product: ./predict_soc.a
...
PRODUCT_NAME              = predict_soc
MAKEFILE                  = predict_soc_rtw.mk
MATLAB_ROOT               = /Applications/MATLAB_R2026a.app
MATLAB_BIN                = /Applications/MATLAB_R2026a.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maca64
START_DIR                 = /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option2_matlab_pytorch_coder/outputDir
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/arkadiyturevskiy/Documents/Claude/SOC_model/option2_matlab_pytorch_coder -I$(MATLAB_ROOT)/extern/include
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=predict_soc
...
SRCS = $(START_DIR)/predict_soc_data.c $(START_DIR)/predict_soc_initialize.c $(START_DIR)/predict_soc_terminate.c $(START_DIR)/predict_soc.c
...
OBJS = predict_soc_data.o predict_soc_initialize.o predict_soc_terminate.o predict_soc.o
...
%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option2_matlab_pytorch_coder/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option2_matlab_pytorch_coder/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option2_matlab_pytorch_coder/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option2_matlab_pytorch_coder/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option2_matlab_pytorch_coder/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
predict_soc_data.o : $(START_DIR)/predict_soc_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_soc_initialize.o : $(START_DIR)/predict_soc_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_soc_terminate.o : $(START_DIR)/predict_soc_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_soc.o : $(START_DIR)/predict_soc.c
	$(CC) $(CFLAGS) -o "$@" "$<"
