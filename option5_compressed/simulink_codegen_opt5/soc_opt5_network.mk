###########################################################################
## Makefile generated for component 'soc_opt5_network'. 
## 
## Makefile     : soc_opt5_network.mk
## Generated on : Fri Mar 27 22:16:36 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/soc_opt5_network
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/soc_opt5_network
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/soc_opt5_network_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=soc_opt5_network -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/soc_opt5_network_ert_rtw/soc_opt5_network.c $(START_DIR)/soc_opt5_network_ert_rtw/soc_opt5_network_data.c

MAIN_SRC = $(START_DIR)/soc_opt5_network_ert_rtw/ert_main.c
...
OBJS = soc_opt5_network.o soc_opt5_network_data.o
...
%.o : $(START_DIR)/soc_opt5_network_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/soc_opt5_network_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/soc_opt5_network_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/soc_opt5_network_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/soc_opt5_network_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/soc_opt5_network_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


soc_opt5_network.o : $(START_DIR)/soc_opt5_network_ert_rtw/soc_opt5_network.c
	$(CC) $(CFLAGS) -o "$@" "$<"


soc_opt5_network_data.o : $(START_DIR)/soc_opt5_network_ert_rtw/soc_opt5_network_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
