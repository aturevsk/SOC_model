###########################################################################
## Makefile generated for component 'predict_soc_opt5_direct'. 
## 
## Makefile     : predict_soc_opt5_direct_rtw.mk
## Generated on : Fri Mar 27 20:14:15 2026
## Final product: ./predict_soc_opt5_direct.a
...
PRODUCT_NAME              = predict_soc_opt5_direct
MAKEFILE                  = predict_soc_opt5_direct_rtw.mk
MATLAB_ROOT               = /Applications/MATLAB_R2026a.app
MATLAB_BIN                = /Applications/MATLAB_R2026a.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maca64
START_DIR                 = /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option5_compressed/comp_direct_codegen_opt5
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELLIB                  = predict_soc_opt5_direct.a
...
PRODUCT = ./predict_soc_opt5_direct.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/arkadiyturevskiy/Documents/Claude/SOC_model/option5_compressed -I$(MATLAB_ROOT)/extern/include
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=predict_soc_opt5_direct
...
SRCS = $(START_DIR)/predict_soc_opt5_direct_data.c $(START_DIR)/predict_soc_opt5_direct_initialize.c $(START_DIR)/predict_soc_opt5_direct_terminate.c $(START_DIR)/predict_soc_opt5_direct.c $(START_DIR)/loadDeepLearningNetwork.c $(START_DIR)/predict.c $(START_DIR)/callPredict.c $(START_DIR)/elementwiseOperationInPlace.c $(START_DIR)/addBiasApplyActivation.c $(START_DIR)/predict_soc_opt5_direct_emxutil.c
...
OBJS = predict_soc_opt5_direct_data.o predict_soc_opt5_direct_initialize.o predict_soc_opt5_direct_terminate.o predict_soc_opt5_direct.o loadDeepLearningNetwork.o predict.o callPredict.o elementwiseOperationInPlace.o addBiasApplyActivation.o predict_soc_opt5_direct_emxutil.o
...
%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option5_compressed/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option5_compressed/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option5_compressed/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option5_compressed/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option5_compressed/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
predict_soc_opt5_direct_data.o : $(START_DIR)/predict_soc_opt5_direct_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_soc_opt5_direct_initialize.o : $(START_DIR)/predict_soc_opt5_direct_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_soc_opt5_direct_terminate.o : $(START_DIR)/predict_soc_opt5_direct_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_soc_opt5_direct.o : $(START_DIR)/predict_soc_opt5_direct.c
	$(CC) $(CFLAGS) -o "$@" "$<"


loadDeepLearningNetwork.o : $(START_DIR)/loadDeepLearningNetwork.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict.o : $(START_DIR)/predict.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
elementwiseOperationInPlace.o : $(START_DIR)/elementwiseOperationInPlace.c
	$(CC) $(CFLAGS) -o "$@" "$<"


addBiasApplyActivation.o : $(START_DIR)/addBiasApplyActivation.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_soc_opt5_direct_emxutil.o : $(START_DIR)/predict_soc_opt5_direct_emxutil.c
	$(CC) $(CFLAGS) -o "$@" "$<"
