###########################################################################
## Makefile generated for component 'predict_soc_native'. 
## 
## Makefile     : predict_soc_native_rtw.mk
## Generated on : Fri Mar 27 17:49:41 2026
## Final product: ./predict_soc_native.a
...
PRODUCT_NAME              = predict_soc_native
MAKEFILE                  = predict_soc_native_rtw.mk
MATLAB_ROOT               = /Applications/MATLAB_R2026a.app
MATLAB_BIN                = /Applications/MATLAB_R2026a.app/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/maca64
START_DIR                 = /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option5_matlab_manual_dlnetwork/outputDir
TGT_FCN_LIB               = ISO_C
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/arkadiyturevskiy/Documents/Claude/SOC_model/option5_matlab_manual_dlnetwork -I$(MATLAB_ROOT)/extern/include
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=predict_soc_native
...
SRCS = $(START_DIR)/predict_soc_native_data.c $(START_DIR)/predict_soc_native_initialize.c $(START_DIR)/predict_soc_native_terminate.c $(START_DIR)/predict_soc_native.c $(START_DIR)/loadDeepLearningNetwork.c $(START_DIR)/predict.c $(START_DIR)/callPredict.c $(START_DIR)/elementwiseOperationInPlace.c $(START_DIR)/addBiasApplyActivation.c $(START_DIR)/predict_soc_native_emxutil.c
...
OBJS = predict_soc_native_data.o predict_soc_native_initialize.o predict_soc_native_terminate.o predict_soc_native.o loadDeepLearningNetwork.o predict.o callPredict.o elementwiseOperationInPlace.o addBiasApplyActivation.o predict_soc_native_emxutil.o
...
%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option5_matlab_manual_dlnetwork/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option5_matlab_manual_dlnetwork/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option5_matlab_manual_dlnetwork/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option5_matlab_manual_dlnetwork/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option5_matlab_manual_dlnetwork/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
predict_soc_native_data.o : $(START_DIR)/predict_soc_native_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_soc_native_initialize.o : $(START_DIR)/predict_soc_native_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_soc_native_terminate.o : $(START_DIR)/predict_soc_native_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_soc_native.o : $(START_DIR)/predict_soc_native.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
predict_soc_native_emxutil.o : $(START_DIR)/predict_soc_native_emxutil.c
	$(CC) $(CFLAGS) -o "$@" "$<"
