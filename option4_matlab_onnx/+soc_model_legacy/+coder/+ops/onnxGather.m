...
% Copyright 2024 The MathWorks, Inc.
    ...
    X          = soc_model_legacy.coder.ops.extractIfDlarray(X_);
    ONNXIdx    = soc_model_legacy.coder.ops.extractIfDlarray(ONNXIdx_);
    ONNXAxis   = soc_model_legacy.coder.ops.extractIfDlarray(ONNXAxis_);
    numDimsX   = soc_model_legacy.coder.ops.extractIfDlarray(numDimsX_);
    numDimsIdx = soc_model_legacy.coder.ops.extractIfDlarray(numDimsIdx_);
