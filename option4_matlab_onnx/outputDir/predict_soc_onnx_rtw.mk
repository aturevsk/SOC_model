###########################################################################
## Makefile generated for component 'predict_soc_onnx'. 
## 
## Makefile     : predict_soc_onnx_rtw.mk
## Generated on : Fri Mar 27 17:53:56 2026
## Final product: ./predict_soc_onnx.a
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I/Users/arkadiyturevskiy/Documents/Claude/SOC_model/option4_matlab_onnx -I$(MATLAB_ROOT)/extern/include
...
DEFINES_CUSTOM = 
DEFINES_STANDARD = -DMODEL=predict_soc_onnx
...
SRCS = $(START_DIR)/predict_soc_onnx_data.c $(START_DIR)/predict_soc_onnx_initialize.c $(START_DIR)/predict_soc_onnx_terminate.c $(START_DIR)/predict_soc_onnx.c $(START_DIR)/predict.c $(START_DIR)/callPredict.c $(START_DIR)/elementwiseOperationInPlace.c
...
OBJS = predict_soc_onnx_data.o predict_soc_onnx_initialize.o predict_soc_onnx_terminate.o predict_soc_onnx.o predict.o callPredict.o elementwiseOperationInPlace.o
...
%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option4_matlab_onnx/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option4_matlab_onnx/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option4_matlab_onnx/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option4_matlab_onnx/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : /Users/arkadiyturevskiy/Documents/Claude/SOC_model/option4_matlab_onnx/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
predict_soc_onnx_data.o : $(START_DIR)/predict_soc_onnx_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_soc_onnx_initialize.o : $(START_DIR)/predict_soc_onnx_initialize.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_soc_onnx_terminate.o : $(START_DIR)/predict_soc_onnx_terminate.c
	$(CC) $(CFLAGS) -o "$@" "$<"


predict_soc_onnx.o : $(START_DIR)/predict_soc_onnx.c
	$(CC) $(CFLAGS) -o "$@" "$<"
